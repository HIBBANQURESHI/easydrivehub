...
export default function PaymentPage() {
  return (
    <MainLayout>
      <Suspense fallback={
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F9F6EE]/80 to-[#fdeecd]/80">
          <Loader2 className="h-12 w-12 animate-spin text-[#820000]" />
        </div>
      }>
        <PaymentContent />
      </Suspense>
