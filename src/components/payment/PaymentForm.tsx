  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={fadeIn} className="max-w-2xl mx-auto">
      <Card className="border-[#fdeecd] rounded-2xl shadow-xl">
        <CardHeader>
          <CardTitle className="text-3xl text-[#820000] text-center">Secure Payment</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <input
                ...
                className="w-full p-3 border rounded-lg border-[#820000]"
                required
              />
              <input
                type="email"
            ...
            <Button
              ...
              className={`w-full py-6 text-lg rounded-xl bg-[#820000] hover:bg-[#6a0000] text-[#fdeecd] ${
